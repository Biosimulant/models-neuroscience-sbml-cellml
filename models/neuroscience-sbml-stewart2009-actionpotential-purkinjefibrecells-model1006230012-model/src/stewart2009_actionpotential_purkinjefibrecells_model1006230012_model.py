...
"""Auto-generated SBML BioModule wrapper for Stewart2009_ActionPotential_PurkinjeFibreCells.

Source: biomodels_ebi:MODEL1006230012
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230012
"""
...
class SbmlStewart2009ActionpotentialPurkinjefibrecells(biosim.BioModule):
    """BioModule wrapper for SBML model: Stewart2009_ActionPotential_PurkinjeFibreCells."""

    def __init__(self, model_path: str = "data/MODEL1006230012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stewart2009ActionpotentialPurkinjefibrecellsModel1006230012Model = SbmlStewart2009ActionpotentialPurkinjefibrecells
