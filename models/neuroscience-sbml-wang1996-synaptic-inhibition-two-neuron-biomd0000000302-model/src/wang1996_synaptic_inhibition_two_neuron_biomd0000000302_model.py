...
"""Auto-generated SBML BioModule wrapper for Wang1996_Synaptic_Inhibition_Two_Neuron.

Source: biomodels_ebi:BIOMD0000000302
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000302
"""
...
class SbmlWang1996SynapticInhibitionTwoNeuron(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang1996_Synaptic_Inhibition_Two_Neuron."""

    def __init__(self, model_path: str = "data/BIOMD0000000302.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang1996SynapticInhibitionTwoNeuronBiomd0000000302Model = SbmlWang1996SynapticInhibitionTwoNeuron
