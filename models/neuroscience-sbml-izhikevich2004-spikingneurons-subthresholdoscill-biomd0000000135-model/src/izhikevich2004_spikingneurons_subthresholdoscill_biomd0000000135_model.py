...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_subthresholdOscillations.

Source: biomodels_ebi:BIOMD0000000135
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000135
"""
...
class SbmlIzhikevich2004SpikingneuronsSubthresholdoscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_subthresholdOscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000135.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsSubthresholdoscillBiomd0000000135Model = SbmlIzhikevich2004SpikingneuronsSubthresholdoscillations
