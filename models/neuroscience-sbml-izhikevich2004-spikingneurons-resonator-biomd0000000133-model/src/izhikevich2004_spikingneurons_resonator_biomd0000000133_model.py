...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_resonator.

Source: biomodels_ebi:BIOMD0000000133
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000133
"""
...
class SbmlIzhikevich2004SpikingneuronsResonator(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_resonator."""

    def __init__(self, model_path: str = "data/BIOMD0000000133.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsResonatorBiomd0000000133Model = SbmlIzhikevich2004SpikingneuronsResonator
