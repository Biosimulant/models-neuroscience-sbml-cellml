...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_Class1Excitable.

Source: biomodels_ebi:BIOMD0000000141
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000141
"""
...
class SbmlIzhikevich2004SpikingneuronsClass1excitable(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_Class1Excitable."""

    def __init__(self, model_path: str = "data/BIOMD0000000141.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsClass1excitableBiomd0000000141Model = SbmlIzhikevich2004SpikingneuronsClass1excitable
