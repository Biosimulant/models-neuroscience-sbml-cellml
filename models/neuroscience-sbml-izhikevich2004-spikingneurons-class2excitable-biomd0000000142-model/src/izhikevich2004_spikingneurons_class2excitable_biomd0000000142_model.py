...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_Class2Excitable.

Source: biomodels_ebi:BIOMD0000000142
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000142
"""
...
class SbmlIzhikevich2004SpikingneuronsClass2excitable(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_Class2Excitable."""

    def __init__(self, model_path: str = "data/BIOMD0000000142.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsClass2excitableBiomd0000000142Model = SbmlIzhikevich2004SpikingneuronsClass2excitable
