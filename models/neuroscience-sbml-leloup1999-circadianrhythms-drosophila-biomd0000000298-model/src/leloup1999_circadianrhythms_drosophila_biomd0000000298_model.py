...
"""Auto-generated SBML BioModule wrapper for Leloup1999_CircadianRhythms_Drosophila.

Source: biomodels_ebi:BIOMD0000000298
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000298
"""
...
class SbmlLeloup1999CircadianrhythmsDrosophila(biosim.BioModule):
    """BioModule wrapper for SBML model: Leloup1999_CircadianRhythms_Drosophila."""

    def __init__(self, model_path: str = "data/BIOMD0000000298.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leloup1999CircadianrhythmsDrosophilaBiomd0000000298Model = SbmlLeloup1999CircadianrhythmsDrosophila
