...
"""Auto-generated SBML BioModule wrapper for Phillips2003 - The Mechanism of Ras GTPase Activation by Neurofibromin.

Source: biomodels_ebi:BIOMD0000000692
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000692
"""
...
class SbmlPhillips2003TheMechanismOfRasGtpaseActivationBy(biosim.BioModule):
    """BioModule wrapper for SBML model: Phillips2003 - The Mechanism of Ras GTPase Activation by Neurofibromin."""

    def __init__(self, model_path: str = "data/BIOMD0000000692.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Phillips2003TheMechanismOfRasGtpaseActivatBiomd0000000692Model = SbmlPhillips2003TheMechanismOfRasGtpaseActivationBy
