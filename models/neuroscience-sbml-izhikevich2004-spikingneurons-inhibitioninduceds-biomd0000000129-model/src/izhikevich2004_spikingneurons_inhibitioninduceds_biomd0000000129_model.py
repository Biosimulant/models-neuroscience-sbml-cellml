...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_inhibitionInducedSpiking.

Source: biomodels_ebi:BIOMD0000000129
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000129
"""
...
class SbmlIzhikevich2004SpikingneuronsInhibitioninducedspiking(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_inhibitionInducedSpiking."""

    def __init__(self, model_path: str = "data/BIOMD0000000129.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsInhibitioninducedsBiomd0000000129Model = SbmlIzhikevich2004SpikingneuronsInhibitioninducedspiking
