...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_reboundSpike.

Source: biomodels_ebi:BIOMD0000000132
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000132
"""
...
class SbmlIzhikevich2004SpikingneuronsReboundspike(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_reboundSpike."""

    def __init__(self, model_path: str = "data/BIOMD0000000132.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsReboundspikeBiomd0000000132Model = SbmlIzhikevich2004SpikingneuronsReboundspike
