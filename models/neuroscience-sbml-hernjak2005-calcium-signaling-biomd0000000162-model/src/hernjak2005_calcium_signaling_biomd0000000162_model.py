...
"""Auto-generated SBML BioModule wrapper for Hernjak2005_Calcium_Signaling.

Source: biomodels_ebi:BIOMD0000000162
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000162
"""
...
class SbmlHernjak2005CalciumSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Hernjak2005_Calcium_Signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000162.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hernjak2005CalciumSignalingBiomd0000000162Model = SbmlHernjak2005CalciumSignaling
