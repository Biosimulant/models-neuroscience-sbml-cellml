...
"""Auto-generated SBML BioModule wrapper for Faber2000_LRmodel_CardiacMyocytes.

Source: biomodels_ebi:MODEL0912153452
Original: https://www.ebi.ac.uk/biomodels/MODEL0912153452
"""
...
class SbmlFaber2000LrmodelCardiacmyocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Faber2000_LRmodel_CardiacMyocytes."""

    def __init__(self, model_path: str = "data/MODEL0912153452.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Faber2000LrmodelCardiacmyocytesModel0912153452Model = SbmlFaber2000LrmodelCardiacmyocytes
