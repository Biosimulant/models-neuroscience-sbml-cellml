...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_SpikeLatency.

Source: biomodels_ebi:BIOMD0000000134
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000134
"""
...
class SbmlIzhikevich2004SpikingneuronsSpikelatency(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_SpikeLatency."""

    def __init__(self, model_path: str = "data/BIOMD0000000134.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsSpikelatencyBiomd0000000134Model = SbmlIzhikevich2004SpikingneuronsSpikelatency
