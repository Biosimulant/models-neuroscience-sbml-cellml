...
"""Auto-generated SBML BioModule wrapper for Izhikevich2003_SpikingNeuron.

Source: biomodels_ebi:BIOMD0000000127
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000127
"""
...
class SbmlIzhikevich2003Spikingneuron(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2003_SpikingNeuron."""

    def __init__(self, model_path: str = "data/BIOMD0000000127.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2003SpikingneuronBiomd0000000127Model = SbmlIzhikevich2003Spikingneuron
