...
"""Auto-generated SBML BioModule wrapper for Akman2008_Circadian_Clock_Model1.

Source: biomodels_ebi:BIOMD0000000295
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000295
"""
...
class SbmlAkman2008CircadianClockModel1(biosim.BioModule):
    """BioModule wrapper for SBML model: Akman2008_Circadian_Clock_Model1."""

    def __init__(self, model_path: str = "data/BIOMD0000000295.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Akman2008CircadianClockModel1Biomd0000000295Model = SbmlAkman2008CircadianClockModel1
