...
"""Auto-generated SBML BioModule wrapper for Somogyi1990_CaOscillations_SingleCaSpike.

Source: biomodels_ebi:BIOMD0000000115
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000115
"""
...
class SbmlSomogyi1990CaoscillationsSinglecaspike(biosim.BioModule):
    """BioModule wrapper for SBML model: Somogyi1990_CaOscillations_SingleCaSpike."""

    def __init__(self, model_path: str = "data/BIOMD0000000115.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Somogyi1990CaoscillationsSinglecaspikeBiomd0000000115Model = SbmlSomogyi1990CaoscillationsSinglecaspike
