...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-Bace: Prediction of Beta-secretase 1 (BACE-1) inhibition..

Source: biomodels_ebi:MODEL2406050003
Original: https://www.ebi.ac.uk/biomodels/MODEL2406050003
"""
...
class SbmlRong2020GroverBacePredictionOfBetaSecretase1Bace1(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-Bace: Prediction of Beta-secretase 1 (BACE-1) inhibition.."""

    def __init__(self, model_path: str = "data/MODEL2406050003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverBacePredictionOfBetaSecretasModel2406050003Model = SbmlRong2020GroverBacePredictionOfBetaSecretase1Bace1
