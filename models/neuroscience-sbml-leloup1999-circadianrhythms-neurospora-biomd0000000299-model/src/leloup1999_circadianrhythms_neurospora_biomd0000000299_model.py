...
"""Auto-generated SBML BioModule wrapper for Leloup1999_CircadianRhythms_Neurospora.

Source: biomodels_ebi:BIOMD0000000299
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000299
"""
...
class SbmlLeloup1999CircadianrhythmsNeurospora(biosim.BioModule):
    """BioModule wrapper for SBML model: Leloup1999_CircadianRhythms_Neurospora."""

    def __init__(self, model_path: str = "data/BIOMD0000000299.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leloup1999CircadianrhythmsNeurosporaBiomd0000000299Model = SbmlLeloup1999CircadianrhythmsNeurospora
