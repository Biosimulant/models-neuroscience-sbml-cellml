...
"""Auto-generated SBML BioModule wrapper for Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism.

Source: biomodels_ebi:BIOMD0000000567
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000567
"""
...
class SbmlMorris2008FittingProteinAggregationDataViaFW2Step(biosim.BioModule):
    """BioModule wrapper for SBML model: Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism."""

    def __init__(self, model_path: str = "data/BIOMD0000000567.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Morris2008FittingProteinAggregationDataViaBiomd0000000567Model = SbmlMorris2008FittingProteinAggregationDataViaFW2Step
