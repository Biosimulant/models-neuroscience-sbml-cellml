...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_reboundBurst.

Source: biomodels_ebi:BIOMD0000000131
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000131
"""
...
class SbmlIzhikevich2004SpikingneuronsReboundburst(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_reboundBurst."""

    def __init__(self, model_path: str = "data/BIOMD0000000131.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsReboundburstBiomd0000000131Model = SbmlIzhikevich2004SpikingneuronsReboundburst
