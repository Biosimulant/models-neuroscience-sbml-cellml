...
"""Auto-generated SBML BioModule wrapper for Ouzounoglou2014 - Modeling of alpha-synuclein effects on neuronal homeostasis.

Source: biomodels_ebi:BIOMD0000000559
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000559
"""
...
class SbmlOuzounoglou2014ModelingOfAlphaSynucleinEffectsOn(biosim.BioModule):
    """BioModule wrapper for SBML model: Ouzounoglou2014 - Modeling of alpha-synuclein effects on neuronal homeostasis."""

    def __init__(self, model_path: str = "data/BIOMD0000000559.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ouzounoglou2014ModelingOfAlphaSynucleinEffeBiomd0000000559Model = SbmlOuzounoglou2014ModelingOfAlphaSynucleinEffectsOn
