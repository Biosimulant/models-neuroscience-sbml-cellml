...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_thresholdVariability.

Source: biomodels_ebi:BIOMD0000000136
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000136
"""
...
class SbmlIzhikevich2004SpikingneuronsThresholdvariability(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_thresholdVariability."""

    def __init__(self, model_path: str = "data/BIOMD0000000136.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsThresholdvariabiliBiomd0000000136Model = SbmlIzhikevich2004SpikingneuronsThresholdvariability
