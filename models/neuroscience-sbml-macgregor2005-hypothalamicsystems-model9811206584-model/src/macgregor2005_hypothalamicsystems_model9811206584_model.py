...
"""Auto-generated SBML BioModule wrapper for MacGregor2005_HypothalamicSystems.

Source: biomodels_ebi:MODEL9811206584
Original: https://www.ebi.ac.uk/biomodels/MODEL9811206584
"""
...
class SbmlMacgregor2005Hypothalamicsystems(biosim.BioModule):
    """BioModule wrapper for SBML model: MacGregor2005_HypothalamicSystems."""

    def __init__(self, model_path: str = "data/MODEL9811206584.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Macgregor2005HypothalamicsystemsModel9811206584Model = SbmlMacgregor2005Hypothalamicsystems
