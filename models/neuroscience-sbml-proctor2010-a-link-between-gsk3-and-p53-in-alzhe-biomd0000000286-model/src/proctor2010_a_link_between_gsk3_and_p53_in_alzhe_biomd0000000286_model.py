...
"""Auto-generated SBML BioModule wrapper for Proctor2010 - a link between GSK3 and p53 in Alzheimer's Disease.

Source: biomodels_ebi:BIOMD0000000286
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000286
"""
...
class SbmlProctor2010ALinkBetweenGsk3AndP53InAlzheimerS(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2010 - a link between GSK3 and p53 in Alzheimer's Disease."""

    def __init__(self, model_path: str = "data/BIOMD0000000286.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2010ALinkBetweenGsk3AndP53InAlzheBiomd0000000286Model = SbmlProctor2010ALinkBetweenGsk3AndP53InAlzheimerS
