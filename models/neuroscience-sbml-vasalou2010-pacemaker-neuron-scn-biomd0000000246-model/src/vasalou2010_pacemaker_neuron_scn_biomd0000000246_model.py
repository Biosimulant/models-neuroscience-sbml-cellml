...
"""Auto-generated SBML BioModule wrapper for Vasalou2010_Pacemaker_Neuron_SCN.

Source: biomodels_ebi:BIOMD0000000246
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000246
"""
...
class SbmlVasalou2010PacemakerNeuronScn(biosim.BioModule):
    """BioModule wrapper for SBML model: Vasalou2010_Pacemaker_Neuron_SCN."""

    def __init__(self, model_path: str = "data/BIOMD0000000246.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vasalou2010PacemakerNeuronScnBiomd0000000246Model = SbmlVasalou2010PacemakerNeuronScn
