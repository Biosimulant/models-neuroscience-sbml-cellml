...
"""Auto-generated SBML BioModule wrapper for hodgkin-huxley squid-axon 1952.

Source: biomodels_ebi:BIOMD0000000020
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000020
"""
...
class SbmlHodgkinHuxleySquidAxon1952(biosim.BioModule):
    """BioModule wrapper for SBML model: hodgkin-huxley squid-axon 1952."""

    def __init__(self, model_path: str = "data/BIOMD0000000020.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HodgkinHuxleySquidAxon1952Biomd0000000020Model = SbmlHodgkinHuxleySquidAxon1952
