...
"""Auto-generated SBML BioModule wrapper for D1 LTP time window.

Source: biomodels_ebi:MODEL1603270000
Original: https://www.ebi.ac.uk/biomodels/MODEL1603270000
"""
...
class SbmlD1LtpTimeWindow(biosim.BioModule):
    """BioModule wrapper for SBML model: D1 LTP time window."""

    def __init__(self, model_path: str = "data/MODEL1603270000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
D1LtpTimeWindowModel1603270000Model = SbmlD1LtpTimeWindow
