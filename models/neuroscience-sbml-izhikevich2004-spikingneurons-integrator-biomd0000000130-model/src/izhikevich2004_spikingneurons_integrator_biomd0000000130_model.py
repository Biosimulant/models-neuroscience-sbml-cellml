...
"""Auto-generated SBML BioModule wrapper for Izhikevich2004_SpikingNeurons_integrator.

Source: biomodels_ebi:BIOMD0000000130
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000130
"""
...
class SbmlIzhikevich2004SpikingneuronsIntegrator(biosim.BioModule):
    """BioModule wrapper for SBML model: Izhikevich2004_SpikingNeurons_integrator."""

    def __init__(self, model_path: str = "data/BIOMD0000000130.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Izhikevich2004SpikingneuronsIntegratorBiomd0000000130Model = SbmlIzhikevich2004SpikingneuronsIntegrator
