...
"""Auto-generated SBML BioModule wrapper for Bertram2002_Gprotein_SynapticSignal.

Source: biomodels_ebi:MODEL1006230024
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230024
"""
...
class SbmlBertram2002GproteinSynapticsignal(biosim.BioModule):
    """BioModule wrapper for SBML model: Bertram2002_Gprotein_SynapticSignal."""

    def __init__(self, model_path: str = "data/MODEL1006230024.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bertram2002GproteinSynapticsignalModel1006230024Model = SbmlBertram2002GproteinSynapticsignal
