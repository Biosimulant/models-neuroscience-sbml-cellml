...
"""Auto-generated SBML BioModule wrapper for Lebeda2008 - BoNT paralysis (3 step model).

Source: biomodels_ebi:BIOMD0000000267
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000267
"""
...
class SbmlLebeda2008BontParalysis3StepModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lebeda2008 - BoNT paralysis (3 step model)."""

    def __init__(self, model_path: str = "data/BIOMD0000000267.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lebeda2008BontParalysis3StepModelBiomd0000000267Model = SbmlLebeda2008BontParalysis3StepModel
