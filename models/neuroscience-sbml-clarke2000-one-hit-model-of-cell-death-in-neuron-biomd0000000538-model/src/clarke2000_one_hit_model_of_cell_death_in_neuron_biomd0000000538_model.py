...
"""Auto-generated SBML BioModule wrapper for Clarke2000 - One-hit model of cell death in neuronal degenerations.

Source: biomodels_ebi:BIOMD0000000538
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000538
"""
...
class SbmlClarke2000OneHitModelOfCellDeathInNeuronal(biosim.BioModule):
    """BioModule wrapper for SBML model: Clarke2000 - One-hit model of cell death in neuronal degenerations."""

    def __init__(self, model_path: str = "data/BIOMD0000000538.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Clarke2000OneHitModelOfCellDeathInNeuronBiomd0000000538Model = SbmlClarke2000OneHitModelOfCellDeathInNeuronal
