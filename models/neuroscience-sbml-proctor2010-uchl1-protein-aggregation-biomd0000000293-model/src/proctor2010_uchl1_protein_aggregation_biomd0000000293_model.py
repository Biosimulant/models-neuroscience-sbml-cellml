...
"""Auto-generated SBML BioModule wrapper for Proctor2010 - UCHL1 Protein Aggregation.

Source: biomodels_ebi:BIOMD0000000293
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000293
"""
...
class SbmlProctor2010Uchl1ProteinAggregation(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2010 - UCHL1 Protein Aggregation."""

    def __init__(self, model_path: str = "data/BIOMD0000000293.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2010Uchl1ProteinAggregationBiomd0000000293Model = SbmlProctor2010Uchl1ProteinAggregation
