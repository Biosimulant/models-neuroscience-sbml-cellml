...
"""Auto-generated SBML BioModule wrapper for Voliotis2019-GnRH Pulse Generation.

Source: biomodels_ebi:BIOMD0000000931
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000931
"""
...
class SbmlVoliotis2019GnrhPulseGeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Voliotis2019-GnRH Pulse Generation."""

    def __init__(self, model_path: str = "data/BIOMD0000000931.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Voliotis2019GnrhPulseGenerationBiomd0000000931Model = SbmlVoliotis2019GnrhPulseGeneration
