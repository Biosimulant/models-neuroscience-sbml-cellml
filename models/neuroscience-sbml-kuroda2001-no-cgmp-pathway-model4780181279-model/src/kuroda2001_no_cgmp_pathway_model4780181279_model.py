...
"""Auto-generated SBML BioModule wrapper for Kuroda2001_NO_cGMP_Pathway.

Source: biomodels_ebi:MODEL4780181279
Original: https://www.ebi.ac.uk/biomodels/MODEL4780181279
"""
...
class SbmlKuroda2001NoCgmpPathway(biosim.BioModule):
    """BioModule wrapper for SBML model: Kuroda2001_NO_cGMP_Pathway."""

    def __init__(self, model_path: str = "data/MODEL4780181279.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kuroda2001NoCgmpPathwayModel4780181279Model = SbmlKuroda2001NoCgmpPathway
