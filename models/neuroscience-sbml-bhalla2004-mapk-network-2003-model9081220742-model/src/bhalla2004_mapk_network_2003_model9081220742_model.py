...
"""Auto-generated SBML BioModule wrapper for Bhalla2004_MAPK_network_2003.

Source: biomodels_ebi:MODEL9081220742
Original: https://www.ebi.ac.uk/biomodels/MODEL9081220742
"""
...
class SbmlBhalla2004MapkNetwork2003(biosim.BioModule):
    """BioModule wrapper for SBML model: Bhalla2004_MAPK_network_2003."""

    def __init__(self, model_path: str = "data/MODEL9081220742.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bhalla2004MapkNetwork2003Model9081220742Model = SbmlBhalla2004MapkNetwork2003
