...
"""Auto-generated SBML BioModule wrapper for Purvis2005_IonicCurrentModel.

Source: biomodels_ebi:MODEL7980735163
Original: https://www.ebi.ac.uk/biomodels/MODEL7980735163
"""
...
class SbmlPurvis2005Ioniccurrentmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Purvis2005_IonicCurrentModel."""

    def __init__(self, model_path: str = "data/MODEL7980735163.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Purvis2005IoniccurrentmodelModel7980735163Model = SbmlPurvis2005Ioniccurrentmodel
