...
"""Auto-generated SBML BioModule wrapper for Smolen2018 - Paradoxical LTP maintenance with inhibition of protein synthesis and the proteasome.

Source: biomodels_ebi:BIOMD0000000853
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000853
"""
...
class SbmlSmolen2018ParadoxicalLtpMaintenanceWithInhibitionOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Smolen2018 - Paradoxical LTP maintenance with inhibition of protein synthesis and the proteasome."""

    def __init__(self, model_path: str = "data/BIOMD0000000853.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smolen2018ParadoxicalLtpMaintenanceWithInhiBiomd0000000853Model = SbmlSmolen2018ParadoxicalLtpMaintenanceWithInhibitionOf
