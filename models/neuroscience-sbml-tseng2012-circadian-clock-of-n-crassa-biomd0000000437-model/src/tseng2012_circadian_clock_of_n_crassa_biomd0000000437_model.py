...
"""Auto-generated SBML BioModule wrapper for Tseng2012 - Circadian clock of N.crassa.

Source: biomodels_ebi:BIOMD0000000437
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000437
"""
...
class SbmlTseng2012CircadianClockOfNCrassa(biosim.BioModule):
    """BioModule wrapper for SBML model: Tseng2012 - Circadian clock of N.crassa."""

    def __init__(self, model_path: str = "data/BIOMD0000000437.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tseng2012CircadianClockOfNCrassaBiomd0000000437Model = SbmlTseng2012CircadianClockOfNCrassa
