...
"""Auto-generated SBML BioModule wrapper for Santolini2001_nNOS_Mechanism_Regulation.

Source: biomodels_ebi:BIOMD0000000199
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000199
"""
...
class SbmlSantolini2001NnosMechanismRegulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Santolini2001_nNOS_Mechanism_Regulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000199.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Santolini2001NnosMechanismRegulationBiomd0000000199Model = SbmlSantolini2001NnosMechanismRegulation
