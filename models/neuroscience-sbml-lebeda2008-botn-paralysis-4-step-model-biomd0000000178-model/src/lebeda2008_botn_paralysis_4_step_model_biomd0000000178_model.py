...
"""Auto-generated SBML BioModule wrapper for Lebeda2008 - BoTN Paralysis (4 step model).

Source: biomodels_ebi:BIOMD0000000178
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000178
"""
...
class SbmlLebeda2008BotnParalysis4StepModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lebeda2008 - BoTN Paralysis (4 step model)."""

    def __init__(self, model_path: str = "data/BIOMD0000000178.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lebeda2008BotnParalysis4StepModelBiomd0000000178Model = SbmlLebeda2008BotnParalysis4StepModel
